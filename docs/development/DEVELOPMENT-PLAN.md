...
**Status:** PARTIAL — implementation complete, CI/user verification pending
...
| P0-T02 | PARTIAL | Implementation complete; CI/user verification still pending. |
| P0-T03 | TODO | Next implementation task. |
